...
xcopy "D:\UPI_Outgoing_FILE\Incoming\%_Year_%\%_mm_%\%_today_%\IFO19011406BIN" "D:\Visa FTP\Incoming\upi"
xcopy "D:\UPI_Outgoing_FILE\Incoming\%_Year_%\%_mm_%\%_today_%\IFO19011407BIN" "D:\Visa FTP\Incoming\upi"
